document.addEventListener('DOMContentLoaded', function() {
    ...
    const defaultMenuItems = {
        'coffee': [
            ...
            { id: 'iceCoffee', name: 'アイス コーヒー', price: 400, category: 'coffee' },
            { id: 'iceLatte', name: 'アイス カフェオレ', price: 450, category: 'coffee' }
        ],
        'softDrink': [
            { id: 'lemonade', name: 'レモネード', price: 300, category: 'softDrink' },
            { id: 'appleJuice', name: 'アップル ジュース', price: 300, category: 'softDrink' },
    ...
    const tableNumberKeypad = document.getElementById('tableNumberKeypad');
    ...
    tableNumberKeypad.querySelectorAll('.num-key').forEach(key => {
    ...
    function saveToSpreadsheet(tableNumber) {
        fetch('https://script.google.com/macros/s/AKfycbyvLManPcb1zRuvGkZIVBtRRCSFYpDU0l5SKGOioPVrFYJeWFdc3Sv_m2vF7QPaxXU/exec', {
            method: 'POST',
            mode: 'no-cors',
            headers: {
